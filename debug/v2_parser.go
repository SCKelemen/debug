...
func NewV2Parser() *V2Parser {
	return &V2Parser{}
}

// ParseFlags parses logical expression flag strings (V2 - with logical expressions)
func (p *V2Parser) ParseFlags(flags string, flagMap map[string]DebugFlag, pathMap map[DebugFlag]string) (DebugFlag, []PathSeverityFilter, error) {
...
func (p *V2Parser) parseLogicalExpression(expr string, flagMap map[string]DebugFlag, pathMap map[DebugFlag]string) (DebugFlag, error) {
...
func (p *V2Parser) parseV1Expression(expr string, flagMap map[string]DebugFlag, pathMap map[DebugFlag]string) (DebugFlag, error) {
	var enabledFlags DebugFlag
...
func (p *V2Parser) evaluateExpression(node *ExpressionNode, flagMap map[string]DebugFlag, pathMap map[DebugFlag]string) (DebugFlag, error) {
	switch node.Type {
	case NodeFlag:
...
func (p *V2Parser) evaluateFlag(flagName string, flagMap map[string]DebugFlag, pathMap map[DebugFlag]string) (DebugFlag, error) {
	var enabledFlags DebugFlag
	if err := p.enableFlagsForPattern(flagName, flagMap, pathMap, &enabledFlags); err != nil {
		return 0, err
	}
...
func (p *V2Parser) parseFlagWithSeverity(flagStr string) (string, *SeverityFilter, error) {
...
func (p *V2Parser) parseSeverityFilter(severityStr string) (*SeverityFilter, error) {
...
func (p *V2Parser) parseSeverity(severityStr string) (Severity, error) {
...
func (p *V2Parser) enableFlagsForPattern(pattern string, flagMap map[string]DebugFlag, pathMap map[DebugFlag]string, enabledFlags *DebugFlag) error {
