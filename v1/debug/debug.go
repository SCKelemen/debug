...
// DebugManager manages debug flags and output (V1 - simple configuration)
...
// NewDebugManager creates a new V1 debug manager (simple configuration)
...
// SetFlags sets the debug flags from a string (V1 - simple comma-separated and globs only)
func (dm *DebugManager) SetFlags(flags string) error {
	...
	// V1: Parse comma-separated flags (no logical expressions)
